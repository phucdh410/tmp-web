...
import { MFormDetail } from "@modules/asset-proposal/components";
import { ASSET_PROPOSAL_LIST_PATH } from "@modules/asset-proposal/constants";
import { Stack } from "@mui/material";
import { CPageHeader } from "@others";
import { useQuery } from "@tanstack/react-query";

const AssetProposalFormDetailPage = () => {
  //#region Data
  ...
  return (
    <Stack gap={3}>
      <CPageHeader back={ASSET_PROPOSAL_LIST_PATH}>
        đề xuất tài sản/CCDC
      </CPageHeader>

      <MFormDetail data={data} />
    </Stack>
  );
  //#endregion
};
export default AssetProposalFormDetailPage;
