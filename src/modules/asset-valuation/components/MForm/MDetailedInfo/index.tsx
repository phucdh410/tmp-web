...
export const MDetailedInfo = ({ data }: IMDetailedInfoProps) => {
  return (
    <>
      ...
      <Grid2 container columns={3} columnSpacing={3} rowSpacing={2}>
        <Grid2 size={1}>
        ...
        <Grid2 size={1}>
          <CFormInputWrapper percent={{ label: 35, input: 65 }}>
            ...
            <CInput disabled value={data?.category_name} />
          </CFormInputWrapper>
        </Grid2>
        <Grid2 size={1}>
          <CFormInputWrapper percent={{ label: 35, input: 65 }}>
        ...
        <Grid2 size={1}>
          <CFormInputWrapper percent={{ label: 35, input: 65 }}>
            ...
            <CInput disabled value={data?.store_name} />
          </CFormInputWrapper>
        </Grid2>
        <Grid2 size={1}>
          <CFormInputWrapper percent={{ label: 35, input: 65 }}>
        ...
        <Grid2 size={1}>
          <CFormInputWrapper percent={{ label: 35, input: 65 }}>
            ...
            <CNumberInput disabled value={data?.deprecated_cost} suffix="VNĐ" />
          </CFormInputWrapper>
        </Grid2>
        <Grid2 size={1}>
          <CFormInputWrapper percent={{ label: 35, input: 65 }}>
